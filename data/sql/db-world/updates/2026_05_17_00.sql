...
('mod-quest-helper', 10, 'Quest {} ("{}") removed from realm {}.'),
...
('mod-quest-helper', 10, 'koKR', '퀘스트 {} ("{}")이(가) 렐름 {}에서 제거되었습니다.'),
...
('mod-quest-helper', 10, 'frFR', 'Quête {} ("{}") retirée du royaume {}.'),
...
('mod-quest-helper', 10, 'deDE', 'Quest {} ("{}") aus Realm {} entfernt.'),
...
('mod-quest-helper', 10, 'zhCN', '任务 {} ("{}") 已从领域 {} 中移除。'),
...
('mod-quest-helper', 10, 'zhTW', '任務 {} ("{}") 已從領域 {} 中移除。'),
...
('mod-quest-helper', 10, 'esES', 'Misión {} ("{}") eliminada del reino {}.'),
...
('mod-quest-helper', 10, 'esMX', 'Misión {} ("{}") eliminada del reino {}.'),
...
('mod-quest-helper', 10, 'ruRU', 'Задание {} ("{}") удалено из реалма {}.'),
...
('qh comment add',    1, 'Syntax: .qh comment add $questId [$realmId] $comment\n\nAttaches a comment to a quest. Multiple comments per quest are supported. The assigned comment ID is shown on success. realmId defaults to the current realm.'),
