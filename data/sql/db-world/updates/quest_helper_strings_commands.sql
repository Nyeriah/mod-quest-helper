...
('mod-quest-helper',  3, '|cff4CFF00[Quest Helper] This server automatically notifies you when you accept a quest with a known issue, so you are never left in the dark. Type .qh messages off to disable these messages.|r'),
...
('mod-quest-helper',  3, 'koKR', '|cff4CFF00[퀘스트 도우미] 이 서버는 알려진 문제가 있는 퀘스트를 수락할 때 자동으로 알려드립니다. 알림을 비활성화하려면 .qh messages off 를 입력하세요.|r'),
...
('mod-quest-helper',  3, 'frFR', '|cff4CFF00[Assistant de Quête] Ce serveur vous avertit automatiquement lorsque vous acceptez une quête avec un problème connu, pour que vous ne soyez jamais pris au dépourvu. Tapez .qh messages off pour désactiver ces messages.|r'),
...
('mod-quest-helper',  3, 'deDE', '|cff4CFF00[Quest-Helfer] Dieser Server benachrichtigt dich automatisch, wenn du eine Quest mit einem bekannten Problem annimmst, damit du nie im Dunkeln tappst. Tippe .qh messages off ein, um diese Nachrichten zu deaktivieren.|r'),
...
('mod-quest-helper',  3, 'zhCN', '|cff4CFF00[任务助手] 当您接受存在已知问题的任务时，服务器将自动通知您，让您随时了解情况。输入 .qh messages off 可关闭这些提示。|r'),
...
('mod-quest-helper',  3, 'zhTW', '|cff4CFF00[任務助手] 當您接受存在已知問題的任務時，伺服器將自動通知您，讓您隨時掌握情況。輸入 .qh messages off 可關閉這些提示。|r'),
...
('mod-quest-helper',  3, 'esES', '|cff4CFF00[Asistente de Misiones] Este servidor te avisa automáticamente cuando aceptas una misión con un problema conocido, para que nunca te quedes sin saber qué pasa. Escribe .qh messages off para desactivar estos mensajes.|r'),
...
('mod-quest-helper',  3, 'esMX', '|cff4CFF00[Asistente de Misiones] Este servidor te notifica automáticamente cuando aceptas una misión con un problema conocido, para que siempre estés al tanto. Escribe .qh messages off para desactivar estos mensajes.|r'),
...
('mod-quest-helper',  3, 'ruRU', '|cff4CFF00[Помощник заданий] Этот сервер автоматически уведомляет вас, когда вы берёте задание с известной проблемой, чтобы вы всегда были в курсе. Введите .qh messages off, чтобы отключить эти сообщения.|r'),
